...
def get_score():
    ...
    response = requests.get(
        "https://lit-basin-50781.herokuapp.com/api/score/leaderboard/")
...
def update_score(user, points):
    ...
    url = 'https://lit-basin-50781.herokuapp.com/api/score/update/'
...
def get_question():
    ...
    points = 0
    response = requests.get(
        'https://lit-basin-50781.herokuapp.com/api/random/')
    json_data = json.loads(response.text)
    qs += "Question: \n"
